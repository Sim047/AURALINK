# ✨ AURALINK - Social Network & Communication Platform

A modern, feature-rich social networking and communication platform built with the MERN stack (MongoDB, Express, React, Node.js) and Socket.IO. Auralink combines real-time messaging, social feeds, event management, and sports booking into one seamless experience.
...
### Deployment
- **Frontend:** Vercel (https://auralink-app.vercel.app)
- **Backend:** Railway (https://auralink-app-production.up.railway.app)
...
5. Images will be stored in `auralink/avatars/` and `auralink/posts/` folders
...
**Repository:** [Auralink-App](https://github.com/Sim047/Auralink-App)  
...
Found a bug or have an idea? Open an issue on [GitHub Issues](https://github.com/Sim047/Auralink-App/issues)
...
**Connect, Share, and Explore with AURALINK! 💬✨🏃‍♂️**
